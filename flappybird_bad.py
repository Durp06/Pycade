...
birdplayer_image = f"{directory}\\flap-sprites\\bird.png"
sealevel_image= f"{directory}\\flap-sprites\\base.png"
background_image = f"{directory}\\flap-sprites\\background.jpg"
pipeimage = f"{directory}\\flap-sprites\\pipe.png"
...
if __name__ == "__main__":
	...
	game_images['scoreimages'] = (
        pygame.image.load(f"{directory}\\flap-sprites\\0.png").convert_alpha(),
        pygame.image.load(f"{directory}\\flap-sprites\\1.png").convert_alpha(),
        pygame.image.load(f"{directory}\\flap-sprites\\2.png").convert_alpha(),
        pygame.image.load(f"{directory}\\flap-sprites\\3.png").convert_alpha(),
        pygame.image.load(f"{directory}\\flap-sprites\\4.png").convert_alpha(),
        pygame.image.load(f"{directory}\\flap-sprites\\5.png").convert_alpha(),
        pygame.image.load(f"{directory}\\flap-sprites\\6.png").convert_alpha(),
        pygame.image.load(f"{directory}\\flap-sprites\\7.png").convert_alpha(),
        pygame.image.load(f"{directory}\\flap-sprites\\8.png").convert_alpha(),
        pygame.image.load(f"{directory}\\flap-sprites\\9.png").convert_alpha()
	)
